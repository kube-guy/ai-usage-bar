...
메뉴바 아이콘은 링 두 개와 가운데 글자로 이루어집니다.

| | 뜻 | 표현 |
|---|---|---|
| 바깥 링 (얇고 옅음) | 주간 한도 사용률 | 무채색 |
| 안쪽 링 (굵고 진함) | 5시간 세션 창이 지난 정도 | 무채색 |
| 가운데 글자 | 서비스 구분 + 세션 사용률 | 평소 무채색 · 61%↑ 앰버 · 86%↑ 레드 |
| 옆 숫자 | 세션 사용률 | 텍스트 |

**평소엔 무채색이고 바빠질 때만 색이 붙습니다.** 여유로울 때까지 색을 칠하면 메뉴바가 늘
시끄럽고 정작 경고가 눈에 띄지 않습니다. 색이 나타나는 것 자체가 신호입니다.

두 링은 색 대신 굵기와 농도로 구분합니다. 색은 경고 전용으로 남겨둡니다.

링은 둘 다 **차오르는 방향**입니다. 리셋 순간에 안쪽 링이 완성됩니다.
