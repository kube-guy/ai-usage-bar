...
막대는 **배터리처럼 남은 양**을 칠합니다. 쓸수록 줄어들고, 줄면서 색이 바뀝니다.
바탕을 덧칠하거나 채움 색을 바꾸는 장치는 두지 않습니다 — 남은 만큼만 그리고 색만 바꿉니다.
...
| 11~39% | 앰버 |
| 1~10% | 빨강 |
| 0% (다 씀) | 막대 전체가 빨갛게 비어 있음 |

다 쓰면 칠할 것이 없어 막대가 빈 회색으로 남습니다. 가장 위험한 순간에 신호가 사라지므로
그때는 **빈 트랙 자체를 빨갛게** 둡니다. 채우지 않고 색만 바꾸는 것이라 '가득 찬 상태'와
혼동되지 않습니다.

메뉴의 막대는 **쓴 만큼**을 보여주므로 아이콘과 방향이 반대입니다. 메뉴는 정확한 수치를,
아이콘은 "얼마나 남았나"를 보여줍니다.
...
메뉴의 막대는 **쓴 만큼** 채웁니다. 바로 옆 "사용" 수치와 같은 방향이라야 헷갈리지 않습니다.
막대와 "남음" 수치의 색은 아이콘과 같은 기준(잔여량)을 씁니다.
